CREATE DATABASE  IF NOT EXISTS `sql3201579` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sql3201579`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: sql3201579
-- ------------------------------------------------------
...
CREATE TABLE `classhierarchy` (
  ...
  KEY `FK_ClassHierarchy_ChildId` (`ChildId`),
  CONSTRAINT `FK_ClassHierarchy_ParentId`
  FOREIGN KEY (`ParentId`)
  REFERENCES `sql3201579`.`classifications` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ClassHierarchy_ChildId`
  FOREIGN KEY (`ChildId`)
  REFERENCES `sql3201579`.`classifications` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE `customattributes` (
  ...
  PRIMARY KEY (`Id`),
  CONSTRAINT `fk_customattributeslookup`
  FOREIGN KEY (`LookupId`)
  REFERENCES `sql3201579`.`customattributelookups` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
  ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customattributevalues` (
  ...
  CONSTRAINT `FK_CustomAttributeValues_Attributes`
  FOREIGN KEY (`AttrId`)
  REFERENCES `sql3201579`.`customattributes` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_CustomAttributeValues_Records`
  FOREIGN KEY (`RecordId`)
  REFERENCES `sql3201579`.`records` (`Id`)
    ON DELETE NO ACTION
...
CREATE TABLE `recordclassifications` (
  ...
  CONSTRAINT `FK_RecordClassifications_Classifications`
  FOREIGN KEY (`ClassId`)
  REFERENCES `sql3201579`.`classifications` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_RecordClassifications_Records`
  FOREIGN KEY (`RecordId`)
  REFERENCES `sql3201579`.`records` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE `records` (
  ...
  CONSTRAINT `FK_Records_Containers`
  FOREIGN KEY (`ContainerId`)
  REFERENCES `sql3201579`.`containers` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_Records_Locations`
  FOREIGN KEY (`LocationId`)
  REFERENCES `sql3201579`.`locations` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_Records_RecordStates`
  FOREIGN KEY (`StateId`)
  REFERENCES `sql3201579`.`recordstates` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_Records_RecordTypes`
  FOREIGN KEY (`TypeId`)
  REFERENCES `sql3201579`.`recordtypes` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_Records_Schedule`
  FOREIGN KEY (`ScheduleId`)
  REFERENCES `sql3201579`.`retentionschedules` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
  ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recordtypes` (
  ...
  CONSTRAINT `FK_RecordTypes_RetentionSchedules`
  FOREIGN KEY (`DefaultScheduleId`)
  REFERENCES `sql3201579`.`retentionschedules` (`Id`)
    ON DELETE NO ACTION)
  ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `userlocations` (
  ...
  FOREIGN KEY (`UserId`)
  REFERENCES `sql3201579`.`users` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
  ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `userroles` (
  ...
  FOREIGN KEY (`RoleId`)
  REFERENCES `sql3201579`.`roles` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
