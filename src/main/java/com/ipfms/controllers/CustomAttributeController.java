...
public class CustomAttributeController{
    ...
    public ResponseEntity<Resources<CustomAttribute>> showClassHierarchies() {
        ...
        Resources<CustomAttribute> resources = customAttributeResourceAssembler.toResources(c);
